...
/* 게시판 리스트 */
router.get('/boards/bcId/:bcId', function(req, res){
    return boardCntrl.listBoard(req, res);
});

/* 게시글 id insert */
router.post('/boards/bcId/:bcId', function(req, res){
...
/* 게시글 상세 페이지 */
router.get('/boards/bId/:bId', function(req, res){
    return boardCntrl.detailBoard(req, res);
});

/* 게시글 수정 */
router.put('/boards/bId/:bId', function(req, res){
    return boardCntrl.modifyBoard(req, res);
});

/* 게시글 삭제 */
router.delete('/boards/bId/:bId', function(req, res){
